...
import static seedu.address.logic.commands.DeleteCommand.MESSAGE_PERSON_NOT_EXIST;
...
public class DeleteCommandParserTest {
    ...
    public void parse_validIndex_returnsIndexedDeleteCommand() {
        assertParseSuccess(parser, "1", new IndexedDeleteCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_validName_returnsNamedDeleteCommand() {
        assertParseSuccess(parser, "Alice Pauline", new NamedDeleteCommand(ALICE.getName()));
    }
