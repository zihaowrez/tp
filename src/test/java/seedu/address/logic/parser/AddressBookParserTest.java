...
public class AddressBookParserTest {
    ...
    private CommandBox commandBox = new CommandBox((example1, example2) -> {
        return new CommandResult("example", true, true);
    });
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + PersonUtil.getEditPersonDescriptorDetails(descriptor), commandBox);
    ...
    public void parseCommand_unknownCommand_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_UNKNOWN_COMMAND, () -> parser.parseCommand("unknownCommand", commandBox));
    }
}
