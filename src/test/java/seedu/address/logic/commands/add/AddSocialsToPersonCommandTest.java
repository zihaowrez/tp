...
class AddSocialsToPersonCommandTest {
    ...
    public void constructor_nullPerson_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> new AddSocialsToPersonCommand(null, null));
    }

    @Test
    public void execute_personAcceptedByModel_addSuccessful() throws Exception {
        AddSocialsToPersonCommandTest.ModelStubAcceptingPersonAdded modelStub =
                new AddSocialsToPersonCommandTest.ModelStubAcceptingPersonAdded();
        Person validPerson = new PersonBuilder().build();

        CommandResult commandResult = new AddSocialsToPersonCommand(validPerson).execute(modelStub);
     ...
     */
    private class ModelStubWithPerson extends AddSocialsToPersonCommandTest.ModelStub {
     ...
     */
    private class ModelStubAcceptingPersonAdded extends AddSocialsToPersonCommandTest.ModelStub {
