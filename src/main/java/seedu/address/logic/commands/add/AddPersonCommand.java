...
public class AddPersonCommand extends AddCommand {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a person to the address book. "
            ...
            + PREFIX_SOCIAL_MEDIA + "Telegram, @JohnDoe "
            + PREFIX_SOCIAL_MEDIA + "Instagram, @JohnnyDoe "
            + PREFIX_TAG + "friends "
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        for (Tag tag: toAdd.getTags()) {
            if (tag.equals(getEmergencyContactTag())) {
                throw new CommandException(EmergencyContact.CANNOT_ADD_EMERGENCY_CONTACT_TAG);
            }
        }
